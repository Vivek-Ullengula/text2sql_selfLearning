    ...
    try:
        ...
        if generated_chart_path:
            ...
            try:
                ...
                logger.error(f"Failed to display image in Streamlit: {e}")
    ...
    tools=[
        SQLTools(
            ...
            tables={
                ...
                "v_commissions": "Commission records — columns: commission_id, commission_amount, premium_amount, transaction_date, provider_ref, policy_number",
            },
        ),
